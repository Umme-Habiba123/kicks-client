...
const INITIAL_ITEMS = [
  {
    ...
    price: 130,
    image:
      "https://i.ibb.co.com/LDddM84d/cb2ba65dcb352f04be244ccb4dc65290.jpg",
    size: 10,
    quantity: 1,
  },
];
...
export default function Cart() {
  ...
  const updateQty = (id, qty) =>
    setItems((p) => p.map((it) => (it.id === id ? { ...it, quantity: +qty } : it)));
        ...
        <div className="flex flex-col lg:flex-row gap-5 pb-5 lg:gap-8 items-start">
          ...
          <div className="w-full lg:flex-1">
            <div className="bg-white rounded-2xl p-5 sm:p-6 shadow-sm">
              ...
              <h2 className="font-black text-[#1a1a1a] mb-1"
                style={{ fontFamily: "'Arial Black', Arial, sans-serif", fontSize: "clamp(1.05rem, 2.5vw, 1.25rem)" }}>
                Your Bag
              </h2>
              ...
              {items.length === 0 && (
                <div className="text-center py-10">
                  <p className="text-gray-400 font-semibold mb-4">Your bag is empty</p>
              ...
              {items.map((item, idx) => (
                <div key={item.id}>
                  ...
                  <div className="flex gap-4 sm:gap-5">
                    {/* Image */}
                    <div className="bg-[#f5f5f0] rounded-xl flex-shrink-0 flex
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex justify-between gap-2 mb-1">
                        <p className="font-black text-[#1a1a1a] uppercase leading-tight"
                          style={{ fontFamily: "'Arial Black', Arial, sans-serif", fontSize: "clamp(0.72rem,1.8vw,0.88rem)" }}>
                          {item.name}
                        </p>
                        <p className="text-[#4A69E2] font-black flex-shrink-0"
                          ...
                          <div className="relative">
                            <select
                              ...
                              className="appearance-none bg-transparent border-none
                                         outline-none cursor-pointer pl-0 pr-5 py-0
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <button onClick={() => removeItem(item.id)}
                          ...
                          {/* Bin with lid — matches screenshot icon */}
                          <svg width="19" height="19" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="w-full lg:w-80 xl:w-96 flex-shrink-0 lg:sticky lg:top-6 ">
            <div className="bg-[#e8e6e1] rounded-2xl p-5 sm:p-6">
              ...
              <h2 className="font-black text-[#1a1a1a] mb-5"
                style={{ fontFamily: "'Arial Black', Arial, sans-serif", fontSize: "clamp(1.1rem,2.5vw,1.35rem)" }}>
                Order Summary
              </h2>
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="flex justify-between font-black text-[#1a1a1a] text-lg
              ...
              <button
                ...
                className="w-full bg-[#1a1a1a] text-white font-bold py-3.5 rounded-xl
              ...
              <button
                ...
                className="w-full text-center text-sm text-gray-700 underline
                           underline-offset-2 hover:text-black transition"
              >
              ...
              {promoOpen && (
                <div className="flex gap-2 mt-3">
                  <input
                    ...
                    className="flex-1 border border-gray-400 bg-transparent rounded-lg
                               px-3 py-2 text-sm outline-none focus:border-[#1a1a1a] transition"
                  />
                  <button className="bg-[#1a1a1a] text-white px-4 py-2 rounded-lg
